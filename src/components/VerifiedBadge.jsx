...
/**
 * Pixel-accurate Instagram Verified Badge (8-point scalloped starburst + checkmark)
 */
export const VerifiedBadge = ({ size = 18, className = '' }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-label="Verified"
    >
      {/* 8-point scalloped Instagram verified burst */}
      <path
